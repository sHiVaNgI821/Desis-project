            ...
            <br />
              ...
              <Navbar.Collapse id="basic-navbar-nav">
                  <Nav className="d-md-block">
                      ...
                      <Link className='d-block items mt-0 pt-0 mb-3 text-decoration-none' to ="/savings"><FontAwesomeIcon className='icons2 text-white' icon={faCalculator}/><span className='items2'> Savings Calculator</span></Link>
                      ...
                      <Link className='d-block items mt-0 pt-0 mb-3 text-decoration-none' to="/friends"><FontAwesomeIcon className='icons2 text-white' icon={faUserGroup}/><span className='items2'> Friends</span></Link>
                      ...
                      <Link className='d-block items mt-0 pt-0 mb-5 text-decoration-none' to="/logout"><FontAwesomeIcon className='icons2 text-white' icon={faRightFromBracket}/><span className='items2'> Logout</span></Link>
                  </Nav>
              </Navbar.Collapse>
          </Navbar>
      </div>
